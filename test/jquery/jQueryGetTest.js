  ...
  describe('happy paths', function () {
    describe('single calls', function () {
      ...
      describe('arrangements of thenRespond() withStatusCode(), withHeader() and withData()', function () {
        it('mocks jQuery.get() thenRespond().withHeaders().withData().withStatusCode() as expected', function (done) {
        ...
        it('mocks jQuery.get() thenRespond().withHeaders().withStatusCode().withData() as expected', function (done) {
        ...
        it('mocks jQuery.get() thenRespond().withStatusCode().withHeaders().withData() as expected', function (done) {
        ...
        it('mocks jQuery.get() thenRespond().withData().withHeaders().withStatusCode() as expected', function (done) {
        ...
        it('mocks jQuery.get() thenRespond().withData().withStatusCode().withHeaders() as expected', function (done) {
        ...
        it('mocks jQuery.get() thenRespond().withStatusCode().withData().withHeaders() as expected', function (done) {
